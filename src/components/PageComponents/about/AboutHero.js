              ...
              <div className="flex flex-wrap items-stretch justify-center -mx-4 text-center">
                <div className="relative flex-grow w-full max-w-full px-1 py-3 basis-0">
                  <header className="block px-2 text-neutral-700">
                    <h1
                      className="mx-auto text-4xl font-extrabold tracking-tight text-heading-text dark:text-white font-merriweather "
                      style={{ lineHeight: "1.2" }}
                    >
                      About Us
                    </h1>
                    <p className="relative block p-0 mx-0 my-4 text-lg text-left text-regular-text dark:text-gray-200 font-lato">
                      Starting with only one customer, we have blossomed into a
                      full-service digital marketing agency. Although we have
                      grown exponentially and expanded significantly over the
                      last several years, we're stuck to the same core values
                      that helped us cater to our customers' needs from day one.
                    </p>
                    <p className="relative block p-0 mx-0 mt-0 mb-4 text-lg text-left text-regular-text dark:text-gray-200 font-lato">
                      We strive to provide effective marketing strategies to
                      companies that range in a variety of size and industry.
                      Regardless of your business, there's always room for
                      marketing services. Allow us to surge the presence of your
                      brand through web design, SEO, and ad campaigns. We offer
                      proven digital marketing solutions, and we'll continue to
                      do so, so get started today!
                    </p>
                ...
                <div className="relative py-12 px-4 mt-5 w-full rounded lg:mt-0 lg:flex-shrink-0 lg:flex-grow-0 lg:basis-1/2 lg:text-left bg-opacity-[0.3]">
                  <header className="block px-2 text-lg">
                    <p className="relative block p-0 mx-0 my-4 text-regular-text dark:text-gray-200 font-lato">
                      ...
                      Del Web. I first got started with web development in 2014,
                      building basic websites as class assignments while
                      studying at the University of California, Santa Barbara.
                    </p>
                    <p className="relative block p-0 mx-0 mt-0 mb-4 text-regular-text dark:text-gray-200 font-lato">
                      ...
                      development both as a freelancer and as part of a
                      fantastic team and agency by the name CodeStaff. At the
                      start of 2020, CodeStaff began pivoting to build a
                      freelancing platform. I continued to work alongside them,
                      but began thinking of starting my own agency.
                    </p>
                    <p className="relative block p-0 mx-0 mt-0 mb-4 text-regular-text dark:text-gray-200 font-lato">
                      Then COVID-19 started, and lots of things got thrown into
                      the air at the point. To play it safe, I continued simply
                      doing freelance work for clients I had already worked with
                      around the country.
                    </p>
                    <p className="relative block p-0 mx-0 mt-0 mb-4 text-regular-text dark:text-gray-200 font-lato">
                      As time went on and COVID-19 continued to spread with no
                      end in sight, I realized that many small businesses we're
                      not prepared with an online-focused business model, and
                      we're hurting because of it. That was when I decided to
                      begin laying the foundation to build my own web agency
                      with a focus on local, small businesses.
                    </p>
                    <ul className="p-0 m-0" style={{ listStyle: "none" }} />
                  </header>
                </div>
