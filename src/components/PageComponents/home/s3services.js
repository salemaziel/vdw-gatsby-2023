...
const S3Services = ({ servicesTitle, servicesSubtitle }) => {
  return (
    <>
      ...
      <section className="relative pt-5 pb-3 bg-theme-light-bg dark:bg-theme-dark-bg">
            ...
            <div className="flex items-center justify-end order-1 w-full mx-auto mb-4 sm:order-2 sm:mb-12 lg:w-1/2">
              <div className="flex flex-col items-center justify-center w-full h-full px-2 py-8 lg:p-8">
                ...
                <p className="px-0 py-6 pb-4 mx-auto text-lg text-left md:px-4 dark:text-white">
                  Custom design and development of beautiful, functional
                  websites that are easy to use, easy to navigate, and are fully
                  responsive web pages optimized for all devices and browsers.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-end order-2 w-full mx-auto mb-4 sm:order-1 sm:mb-12 lg:w-1/2">
              <div className="flex flex-col items-center justify-center w-full h-full px-2 py-8 lg:p-8">
                ...
                <p className="px-0 py-6 pb-4 mx-auto text-lg text-left md:px-4 md:text-regular-text md:dark:text-white">
                  Custom E-Commerce websites built to scale. We build eCommerce
                  websites that are easy to use, easy to navigate, and are fully
                  responsive web pages optimized for all devices and browsers.
                </p>
              </div>
        ...
        <Container className="py-12 my-6 sm:py-6">
          <div className="flex flex-col items-center w-full mx-auto mb-4 sm:mb-12 sm:flex-row lg:w-5/6">
            ...
            <div className="flex items-center justify-end order-1 w-full mx-auto mb-4 sm:order-2 sm:mb-12 lg:w-1/2">
              <div className="flex flex-col items-center justify-center w-full h-full px-2 py-8 lg:p-8">
                <h3 className="py-2 mb-6 text-3xl font-medium text-center sm:py-6 dark:text-white">
                  E-Commerce websites built to scale using your favorite
                  platform.
                </h3>
                <div className="px-0 py-6 pb-4 mx-auto text-lg text-left md:px-4 dark:text-white">
                  <p>
                    We build eCommerce websites that are easy to use, easy to
                    navigate, and are fully responsive web pages optimized for
                    all devices and browsers. We can build your eCommerce
                    website using your favorite platform, including:
                  </p>
            ...
            <div className="flex items-center justify-end order-2 w-full mx-auto mb-4 sm:order-1 sm:mb-12 lg:w-1/2">
              <div className="flex flex-col items-center justify-center w-full h-full px-2 py-8 lg:p-8">
                ...
                <p className="px-0 py-6 pb-4 mx-auto text-lg text-left md:px-4 md:text-regular-text dark:text-white">
                  Email marketing is one of the most effective ways to grow your
                  business. We create email marketing campaigns that are
                  designed to convert your subscribers into customers.
                </p>
              </div>
            </div>
            <div className="flex items-center justify-end order-1 w-full mx-auto mb-4 sm:order-2 sm:mb-12 lg:w-1/2">
          ...
          <div className="flex flex-col items-center w-full mx-auto mb-4 sm:mb-12 sm:flex-row lg:w-5/6">
            ...
            <div className="flex items-center justify-end order-1 w-full mx-auto mb-4 sm:order-2 sm:mb-12 lg:w-1/2">
              <div className="flex flex-col items-center justify-center w-full h-full px-2 py-8 lg:p-8">
                ...
                <p className="px-0 py-6 pb-4 mx-auto text-lg text-left md:px-4 dark:text-white">
                  We can help you automate your eCommerce business and optimize
                  your website for conversions. We offer a variety of services,
                  including email marketing automation, on-page and off-page SEO
        ...
        {/* Sixth Row */}
        <Container className="py-12 mt-6 text-white sm:mt-6 sm:py-6 bg-primary-500 dark:bg-primary-800 dark:text-gray-100 md:bg-transparent ">
          <div className="flex flex-col-reverse items-center w-full mx-auto mb-4 sm:mb-12 sm:flex-row lg:w-5/6">
            <div className="flex items-center justify-end order-2 w-full mx-auto mb-4 sm:order-1 sm:mb-12 lg:w-1/2">
              <div className="flex flex-col items-center justify-center w-full h-full px-2 py-8 lg:p-8">
                ...
                <p className="px-4 py-6 pb-4 mx-auto text-lg text-left dark:text-white md:text-regular-text">
                  Video Marketing for YouTube Sacramento. Social Media marketing
                  with AI Generated Video. Build Your Brand Vith Video.
                </p>
              </div>
            </div>
            <div className="flex items-center justify-end order-1 w-full mx-auto mb-4 sm:order-2 sm:mb-12 lg:w-1/2">
