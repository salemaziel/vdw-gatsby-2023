...
function SideBarLayout({children}) {
  return (
    <div className="flex flex-no-wrap">
      ...
      <div className="absolute flex-col justify-between hidden w-64 shadow bg-primary-500 sm:relative md:h-full sm:flex">
        <div className="px-8">

        {/* Sidebar Title Start */}
          <div className="flex items-center justify-center w-full h-16 mx-auto">
        

            <h2 className="pt-4 text-4xl font-semibold text-center text-white">Resources</h2>
          </div>
            {/* Sidebar Title End */} 

            {/* Sidebar Links Start */}
          <ul className="mt-12">
            <li className="flex items-center justify-between w-full mb-6 text-gray-100 cursor-pointer hover:text-gray-200">
              ...
              {/*<div className="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-700 rounded">
                5
              </div>*/}
            </li>
            <li className="flex items-center justify-between w-full mb-6 text-gray-100 cursor-pointer hover:text-gray-300">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="flex items-center justify-between w-full text-gray-100 cursor-pointer hover:text-gray-300">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="px-8 border-t border-gray-700">
          <ul className="flex items-center justify-between w-full bg-primary-500">
        ...
        <div className="px-8">
          ...
          <div className="flex justify-center w-full mt-48 mb-4">
            <div className="relative ">
              ...
              <input
                className="w-full py-2 pl-10 text-sm text-gray-300 bg-gray-100 bg-gray-700 rounded focus:outline-none"
                type="text"
                placeholder="Search"
              />
            </div>
